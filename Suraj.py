...
def contact():
	...
	os.system('xdg-open https://www.facebook.com/WHYYOUCOPYMYPPLINK')
...
\033[1;37m----------------------------------------------
 ...
 DECODE BY  : SURAJ DADDY
 VERSION    : 1.86
 DECODE BY  : SURAJ DADDY
\033[1;37mNote- THIS IS FREE TOOL BUT YOU NEED APPROVAL -""")
def banner():
	print(logo)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[FIGHTER-XD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
